...
<head>
    ...
    <title>Ratu Textile - All In 1 Template</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-7">
                            ...
                            <div class="login">
                                ...
                                <a href="#" data-toggle="modal" data-target="#regis-modal"></i> <span class="hidden-xs text-uppercase">Sign up</span></a>
                            </div>
 ...
 _________________________________________________________ -->
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked category-menu">
                                    <li>
                                        <a href="shop-category.html">Tile<span class="badge pull-right">42</span></a>
                                    </li>
                                    <li class="active">
                                        <a href="shop-category.html">Kembang  <span class="badge pull-right">123</span></a>
                                    </li>
                                    <li>
                                        <a href="shop-category.html">Polos  <span class="badge pull-right">11</span></a>
                                    </li>
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9">
                        ...
                        <p class="text-muted lead">Our Product</p>

                        <div class="row products">

                            <?php
								$all_produk=mysql_query("SELECT * FROM tb_produk ORDER BY id_produk DESC");
								while($produk=mysql_fetch_array($all_produk)){
									$gambar_produk = explode(",",$produk[gambar_produk]);
							?>
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="shop-detail.html">
                                            <img src="img_produk/<?php echo $gambar_produk[0]; ?>" alt="" class="img-responsive image1">
                                        </a> 
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h4 style="margin-bottom:auto;"><a href="shop-detail.html"><?php echo $produk[nama_produk];?></a></h4>
                                        <p class="price">Rp.<?php echo number_format($harga_produk, 0,"." ,"."); ?></p>
                                            <a href="<?php echo "shop-detail.php?id_produk=".$produk[id_produk]; ?>" class="btn btn-default">View detail</a>
        ...
        <footer id="footer">
            <div class="container">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <p><strong>Ratu Textile Ltd.</strong>
                        <br>13/25 New Avenue
